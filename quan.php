...
.footer{
  margin-top: 50px;
    ...
    <body>
		...
		$sql1 = "SELECT COUNT(id_dm) AS SMT FROM sanpham where id_dm = '2'";
...
//		echo ("<br>Tong So MT :  "),  $total_records;
		...
		$sql2 = "SELECT * FROM sanpham where id_dm = '2' LIMIT $start, $limit";
        ...
        ?>
        <div align="center">
		<span class="ftext"><br>DANH SÁCH MẶT HÀNG QUẦN</span>
		...
		//=====================================================================					
 		...
 		//=====================================================================					
            ...
            if ($current_page > 1 && $total_page > 1){
                echo '<a href="phantrang2.PHP?page='.($current_page-1).'">Prev &nbsp;</a> | ';
            }
            ...
            for ($i = 1; $i <= $total_page; $i++){
                ...
                if ($i == $current_page){
                    ...
                    echo '<a href="phantrang2.PHP?page='.$i.'">&nbsp;'.$i.'&nbsp;</a> | ';
                }
            }
 
            // nếu current_page < $total_page và total_page > 1 mới hiển thị nút prev
            if ($current_page < $total_page && $total_page > 1){
                echo '<a href="phantrang2.PHP?page='.($current_page+1).'">&nbsp; Next</a> | ';
            }
           ?>
